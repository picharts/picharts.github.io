...
fig = px.line(presdf, x='Time_Stamp', y=['bestBuyYesCost', 'bestBuyNoCost', 'BestSellYesCost', 'BestSellNoCost'], title='Time Series with Rangeslider')

fig.update_xaxes(rangeslider_visible=True)
fig.write_html(r"testhtml.html")
fig.show()
